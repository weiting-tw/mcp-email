...
# 再用同目錄的 .venv 啟動 mcp_email —— 帳密全部走 env，設定檔裡零密碼。
#
# mcp_email 已支援別名：IMAP_SERVER/IMAP_USERNAME/IMAP_PASSWORD（或 IMAP_HOST/USER/PASS）
...
exec "$DIR/.venv/bin/python" "$DIR/mcp_email.py"
